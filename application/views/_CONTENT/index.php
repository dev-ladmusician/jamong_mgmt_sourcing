                    ...
                    <div class="box-body table-responsive table-container">
                        <table ng-table="tableParams" class="table table-bordered table-hover">
                            <tr ng-repeat="item in $data">
                                ...
                                <td data-title="'조회수'" sortable="'view'" filter="{view: 'text'}">
                                    {{item.view}}</span></td>
                                <td data-title="'좋아요'" sortable="'like'" filter="{like: 'text'}">
                                    {{item.likes}}</span></td>
                                <td data-title="'타입'" sortable="'type'" filter="{type: 'text'}">
                                    {{item.type}}</span></td>
                                <td data-title="'카테고리'" sortable="'category'" filter="{category: 'text'}">
                                    {{item.category}}</span></td>
                                <td data-title="'업로드'" sortable="'datetime'" filter="{datetime: 'text'}">
                                    {{item.datetime}}</span></td>
